...
class WC_Shipping_Method_Bring extends WC_Shipping_Method {
  ...
  public function init_form_fields() {
    ...
    $services          = array(
        ...
        'SINGLE_INDOOR'                => 'Home Delivery Single Indoor',
        'CURBSIDE'                     => 'Home Delivery Curbside',
        'CURBSIDE_EXPRESS'             => 'Home Delivery Curbside Express',
        'CURBSIDE_WEEKEND'             => 'Home Delivery Curbside Weekend',
        'CURBSIDE_WEEKEND_EXPRESS'     => 'Home Delivery Curbside Weekend Express',
        'CURBSIDE_EVENING'             => 'Home Delivery Curbside Evening',
        'DOUBLE_INDOOR'                => 'Home Delivery Double Indoor',
        'INDOOR_LIGHT'                 => 'Home Delivery Indoor Light',
        'SINGLE_INDOOR_EXPRESS'        => 'Home Delivery Single Indoor Express',
        'DOUBLE_INDOOR_EXPRESS'        => 'Home Delivery Double Indoor Express',
        'INDOOR_LIGHT_EXPRESS'         => 'Home Delivery Indoor Light Express',
        'SINGLE_INDOOR_WEEKEND'        => 'Home Delivery Single Indoor Weekend',
        'DOUBLE_INDOOR_WEEKEND'        => 'Home Delivery Double Indoor Weekend',
        'INDOOR_LIGHT_WEEKEND'         => 'Home Delivery Indoor Light Weekend',
        'SINGLE_INDOOR_WEEKEND_EXPRESS'=> 'Home Delivery Single Indoor Weekend Express',
        'DOUBLE_INDOOR_WEEKEND_EXPRESS'=> 'Home Delivery Double Indoor Weekend Express',
        'INDOOR_LIGHT_WEEKEND_EXPRESS' => 'Home Delivery Indoor Light Weekend Express',
        'HOME_DELIVERY_RETURN'         => 'Home Delivery Return Home Delivery',
        'DOUBLE_INDOOR_NO'             => 'Home Delivery Double Indoor (NO)',
        'SINGLE_INDOOR_EVENING'        => 'Home Delivery Single Indoor Evening',
        'DOUBLE_INDOOR_EVENING'        => 'Home Delivery Double Indoor Evening',
        'INDOOR_LIGHT_EVENING'         => 'Home Delivery Indoor Light Evening'
    );
